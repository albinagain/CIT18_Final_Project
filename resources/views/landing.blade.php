...
@if (Route::has('login'))
    <div class="useropti">
        @auth
            <a href="{{ url('/dashboard') }}" class="userpotiLink">
                Dashboard
            </a>
        @else
            <a href="{{ route('login') }}" class="userpotiLink">
                Log in
            </a>
            @if (Route::has('register'))
                <a href="{{ route('register') }}" class="userpotiLink">
                    Register
                </a>
            @endif
        @endauth
...
<div class="container mx-auto antialiased">
    <div class="h-screen flex flex-col items-center pt-10 md:pt-16 lg:pt-32">
        ...
        <a href="{{ route('register') }}" class="btn-lg text-xl" id="but">Start Buying Plants!</a>
    </div>



    <div class ="landing_footer">
        <h1>What is a totally legit plant store?</h1>
        <p>
